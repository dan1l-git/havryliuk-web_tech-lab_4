# Лабораторна робота №4. Реалізація захищеної комунікації у реальному часі
...
У даній лабораторній роботі реалізовано комплексну архітектуру, 
...
Користувач проходить стандартний OIDC Authorization Code Flow (з ЛР №3) 
...
Під час виконання даної лабораторної роботи я розширив свої знання з 
